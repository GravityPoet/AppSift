...
<p align="center">
  <a href="https://github.com/GravityPoet/AppSift/releases/latest"><img src="https://img.shields.io/github/v/release/GravityPoet/AppSift?style=flat-square&label=%D8%AA%D9%86%D8%B2%D9%8A%D9%84" alt="أحدث إصدار"></a>
...
نزّل أحدث ملف `.dmg` من صفحة [Releases](https://github.com/GravityPoet/AppSift/releases/latest)، ثم افتحه واسحب AppSift إلى `/Applications`.
...
- فحص محدود يعتمد على اسم التطبيق الدقيق، ومُعرِّفات الحزم المهيكلة، وبيانات الحاويات، واستحقاقات المطوّر التي تم التحقق منها
...
- يعرض كل عنصر مرشح دليل الملكية الذي أدى إلى مطابقته، وتظهر العناصر المشتركة أو غير المؤكدة منفصلة كعناصر محمية
- تنقل الإزالة العناصر إلى سلة المهملات فقط وتحفظ تقريرًا محليًا بالعناصر المنقولة والمفقودة والفاشلة والمحمية والمستعادة؛ ويمكن تصدير JSON للمسارات مع تحقق SHA-256 أو مسح التقارير دون تغيير سلة المهملات
- حماية تطبيقات النظام — تُستبعَد تطبيقات نظام Apple تلقائيًا
...
المكوّنات الأساسية:
- **AppPathFinder** — مطابِق أدلة محدود وقابل للإلغاء لملفات التطبيقات
