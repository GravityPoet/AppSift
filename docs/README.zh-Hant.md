...
<p align="center">
  <a href="https://github.com/GravityPoet/AppSift/releases/latest"><img src="https://img.shields.io/github/v/release/GravityPoet/AppSift?style=flat-square&label=%E4%B8%8B%E8%BC%89" alt="最新版本"></a>
  <a href="https://github.com/GravityPoet/AppSift/actions/workflows/build.yml"><img src="https://img.shields.io/github/actions/workflow/status/GravityPoet/AppSift/build.yml?style=flat-square&label=Build" alt="建置狀態"></a>
  <img src="https://img.shields.io/badge/macOS-13.0+-blue?style=flat-square" alt="macOS 13.0+">
  <img src="https://img.shields.io/badge/Swift-5.9-orange?style=flat-square" alt="Swift 5.9">
  <a href="../LICENSE"><img src="https://img.shields.io/badge/License-AGPL--3.0%20%2F%20Dual-blue?style=flat-square" alt="AGPL-3.0 授權"></a>
  ...
  <a href="https://github.com/GravityPoet/AppSift/releases"><img src="https://img.shields.io/github/downloads/GravityPoet/AppSift/total?style=flat-square&label=%E4%B8%8B%E8%BC%89%E6%95%B8" alt="下載數"></a>
</p>
...
從 [Releases](https://github.com/GravityPoet/AppSift/releases/latest) 下載最新的 `.dmg`,開啟後將 AppSift 拖曳到 `/Applications`。
...
- 採用有界掃描，並以精確應用程式名稱、結構化 Bundle ID、容器中繼資料和已驗證的 entitlement 作為歸屬證據
- **3 種靈敏度**:Strict(安全)、Enhanced(平衡)、Deep(徹底)
- 顯示所有相關檔案:快取、偏好設定、容器、記錄、支援檔案、啟動代理
- 每個候選項目都會說明命中它的歸屬證據；共享或不確定的項目會以受保護項目另外顯示
- 解除安裝只會移到垃圾桶，並儲存包含已移動、已缺失、失敗、受保護與已還原項目的本機報告；可匯出帶 SHA-256 完整性校驗的路徑 JSON，也可隨時清除報告而不變更垃圾桶
- 系統應用程式保護 — 自動排除 Apple 系統應用程式，避免誤刪
...
核心元件:
- **AppPathFinder** — 可取消、有界的應用程式檔案歸屬證據比對器
...
AGPL-3.0 授權。詳情請參閱 [LICENSE](../LICENSE)。
