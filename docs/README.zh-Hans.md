...
| 功能与核心能力 | 社区免费版 (Community) 🆓 | Pro 商业专业版 (Pro Edition) 🚀 |
|---|:---:|:---:|
| **应用卸载与残留深度清理** | ✅ 包含 | ✅ 包含 |
| **基础系统垃圾与缓存清理** | ✅ 包含 | ✅ 包含 |
| **零遥测与完全离线隐私安全** | ✅ 包含 | ✅ 包含 |
| **Xcode / 模拟器深度清理** | ❌ 基础功能 | ✅ **深度关联与彻底清除** |
| **Docker / Ollama AI 模型清理** | ❌ 基础功能 | ✅ **深度关联与彻底清除** |
| **后台自动静默清理** | ❌ 仅限手动 | ✅ **后台自动化监控与清理** |
| **TCC 隐私权限批量一键重置** | ❌ 仅限手动 | ✅ **批量一键一键重置** |
| **授权协议 (License)** | AGPL-3.0 开源协议 | 商业终身授权 / 企业版 |
