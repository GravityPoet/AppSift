# Contributing to AppSift

Thanks for your interest in contributing to AppSift.

## Getting Started

1. Fork the repo
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/AppSift.git`
3. Install prerequisites: `brew install xcodegen`
4. Generate the Xcode project: `xcodegen generate`
5. Open in Xcode: `open AppSift.xcodeproj`

## Development

- AppSift is built with **SwiftUI** and targets **macOS 13.0+**
