...
<p align="center">
  <b>Reclaim your soldered SSD. A free, open-source, telemetry-free macOS cleaner & uninstaller that saves your storage—and your wallet.</b><br>
  <i>夺回被焊死的 Mac 空间。一款免费、开源、零隐私泄露的 Mac 清理与卸载神器，专治存储焦虑。</i>
</p>
...
|---|---|
| Paying $40+/year for disk utilities just to click "Clean". | **100% Free & Open-Source (MIT)**. Keep your hard-earned budget. |
...
|---|---|
| 每年花 200+ 元订阅清理软件，只为了点一下“一键清理”。 | **100% 免费开源 (MIT)**，把预算留给真正重要的地方。 |
