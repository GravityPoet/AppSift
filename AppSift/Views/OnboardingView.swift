        ...
        VStack(spacing: 18) {
            VStack(spacing: 8) {
                Text(hasFda ? "Permission granted" : "One permission, then we're done")
                    ...
                    .multilineTextAlignment(.center)
                Text(hasFda
                     ? "AppSift can now reach the locations macOS protects by default."
            ...
            if hasFda {
                ...
                // reveal AppSift in Finder, OR grab the draggable icon on the
                ...
                HStack(alignment: .top, spacing: 18) {
                    ...
                    VStack(spacing: 8) {
                        Button {
                            ...
                            Label(hasOpenedSettings ? "Reopen Settings" : "Open Settings & reveal AppSift",
                                  systemImage: "gear")
...
private struct ReadyScene: View {
    ...
    @AppStorage("AppSift.HasSeenWelcomeConfetti") private var hasSeenConfetti = false
