...
/// and offers escape hatches for the "AppSift isn't in the list" case.
struct PermissionSheet: View {
    ...
    private var requestBody: some View {
        VStack(alignment: .leading, spacing: 18) {
            // Two paths the user can choose between: drag the AppSift bundle
            ...
            HStack(alignment: .center, spacing: 14) {
                ...
                VStack(spacing: 8) {
                    Button {
                        ...
                        Label("Open Settings & reveal AppSift", systemImage: "gear")
            ...
            // Step-by-step strip
            HStack(spacing: 0) {
                stepCell(number: 1, title: "Turn on AppSift",
            ...
            HStack(spacing: 8) {
                ...
                Text("Watching for permission change…")
                    ...
                    .foregroundStyle(.secondary)
                Spacer()
                Button(showAdvanced ? "Hide help" : "AppSift not in the list?") {
    ...
    private var advancedPanel: some View {
        VStack(alignment: .leading, spacing: 10) {
            Text("Try this if AppSift doesn't appear:")
            ...
            HStack(spacing: 8) {
                advancedButton(
                    ...
                    title: "Reveal app",
                    subtitle: "Drag AppSift.app into the list"
                ) {
